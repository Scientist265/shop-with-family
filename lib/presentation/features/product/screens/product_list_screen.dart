...
class ProductListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cartViewModel = ref.read(sharedCartViewModelProvider(sessionId).notifier);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: products.when(
          ...
          data: (either) => either.fold(
            (failure) => Center(child: Text('Failed to load: ${failure.message}')),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => context.router.push(SharedCartRoute(sessionId: sessionId)),
